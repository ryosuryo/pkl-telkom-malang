...
<body>
    ...
    <div class="login-content">
        ...
        <div class="nk-block toggled" id="l-login">
            <form method="post" action="<?= base_url()?>index.php/pelanggan/Login_pelanggan/proses_login">
                <h3 style="color: white;font-size: 20px;">LOGIN PELANGGAN</h3>
            <div class="nk-form">
        ...
        <div class="nk-block" id="l-register">
            <form method="post" action="<?= base_url()?>index.php/pelanggan/Login_pelanggan/proses_daftar">
                <h3 style="color: white;font-size: 20px;">DAFTAR</h3>
            <div class="nk-form">
                 <div class="input-group mg-t-15">
